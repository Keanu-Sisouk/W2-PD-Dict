...
asteroidDgm7vtu = XMLUnstructuredGridReader(registrationName='AsteroidDgm7.vtu', FileName=['AsteroidDgms/AsteroidDgm7.vtu'])
...
# create a new 'XML Unstructured Grid Reader'
asteroidDgm12vtu = XMLUnstructuredGridReader(registrationName='AsteroidDgm12.vtu', FileName=['AsteroidDgms/AsteroidDgm12.vtu'])
...
# create a new 'XML Unstructured Grid Reader'
asteroidDgm13vtu = XMLUnstructuredGridReader(registrationName='AsteroidDgm13.vtu', FileName=['AsteroidDgms/AsteroidDgm13.vtu'])
...
# create a new 'XML Unstructured Grid Reader'
asteroidDgm11vtu = XMLUnstructuredGridReader(registrationName='AsteroidDgm11.vtu', FileName=['AsteroidDgms/AsteroidDgm11.vtu'])
...
# create a new 'XML Unstructured Grid Reader'
asteroidDgm14vtu = XMLUnstructuredGridReader(registrationName='AsteroidDgm14.vtu', FileName=['AsteroidDgms/AsteroidDgm14.vtu'])
...
# create a new 'XML Unstructured Grid Reader'
asteroidDgm10vtu = XMLUnstructuredGridReader(registrationName='AsteroidDgm10.vtu', FileName=['AsteroidDgms/AsteroidDgm10.vtu'])
...
# create a new 'XML Unstructured Grid Reader'
asteroidDgm15vtu = XMLUnstructuredGridReader(registrationName='AsteroidDgm15.vtu', FileName=['AsteroidDgms/AsteroidDgm15.vtu'])
...
# create a new 'XML Unstructured Grid Reader'
asteroidDgm2vtu = XMLUnstructuredGridReader(registrationName='AsteroidDgm2.vtu', FileName=['AsteroidDgms/AsteroidDgm2.vtu'])
...
# create a new 'XML Unstructured Grid Reader'
asteroidDgm6vtu = XMLUnstructuredGridReader(registrationName='AsteroidDgm6.vtu', FileName=['AsteroidDgms/AsteroidDgm6.vtu'])
...
# create a new 'XML Unstructured Grid Reader'
asteroidDgm0vtu = XMLUnstructuredGridReader(registrationName='AsteroidDgm0.vtu', FileName=['AsteroidDgms/AsteroidDgm0.vtu'])
...
# create a new 'XML Unstructured Grid Reader'
asteroidDgm9vtu = XMLUnstructuredGridReader(registrationName='AsteroidDgm9.vtu', FileName=['AsteroidDgms/AsteroidDgm9.vtu'])
...
# create a new 'XML Unstructured Grid Reader'
asteroidDgm4vtu = XMLUnstructuredGridReader(registrationName='AsteroidDgm4.vtu', FileName=['AsteroidDgms/AsteroidDgm4.vtu'])
...
# create a new 'XML Unstructured Grid Reader'
asteroidDgm18vtu = XMLUnstructuredGridReader(registrationName='AsteroidDgm18.vtu', FileName=['AsteroidDgms/AsteroidDgm18.vtu'])
...
# create a new 'XML Unstructured Grid Reader'
asteroidDgm5vtu = XMLUnstructuredGridReader(registrationName='AsteroidDgm5.vtu', FileName=['AsteroidDgms/AsteroidDgm5.vtu'])
...
# create a new 'XML Unstructured Grid Reader'
asteroidDgm8vtu = XMLUnstructuredGridReader(registrationName='AsteroidDgm8.vtu', FileName=['AsteroidDgms/AsteroidDgm8.vtu'])
...
# create a new 'XML Unstructured Grid Reader'
asteroidDgm17vtu = XMLUnstructuredGridReader(registrationName='AsteroidDgm17.vtu', FileName=['AsteroidDgms/AsteroidDgm17.vtu'])
...
# create a new 'XML Unstructured Grid Reader'
asteroidDgm3vtu = XMLUnstructuredGridReader(registrationName='AsteroidDgm3.vtu', FileName=['AsteroidDgms/AsteroidDgm3.vtu'])
...
# create a new 'XML Unstructured Grid Reader'
asteroidDgm19vtu = XMLUnstructuredGridReader(registrationName='AsteroidDgm19.vtu', FileName=['AsteroidDgms/AsteroidDgm19.vtu'])
...
# create a new 'XML Unstructured Grid Reader'
asteroidDgm16vtu = XMLUnstructuredGridReader(registrationName='AsteroidDgm16.vtu', FileName=['AsteroidDgms/AsteroidDgm16.vtu'])
...
# create a new 'XML Unstructured Grid Reader'
asteroidDgm1vtu = XMLUnstructuredGridReader(registrationName='AsteroidDgm1.vtu', FileName=['AsteroidDgms/AsteroidDgm1.vtu'])
...
SaveData('Outputs/DictionaryAsteroid.vtm' , OutputPort(tTKPersistenceDiagramDictEncoding1 , 0))
SaveData('Outputs/WeightsAsteroid.csv', OutputPort(tTKPersistenceDiagramDictEncoding1 , 1), Precision = 8)
