...
SaveData('Outputs/DictionaryStartingVortex.vtm' , OutputPort(tTKPersistenceDiagramDictEncoding1 , 0))
SaveData('Outputs/WeightsStartingVortex.csv', OutputPort(tTKPersistenceDiagramDictEncoding1 , 1), Precision = 8)
