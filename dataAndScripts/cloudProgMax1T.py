...
# ----------------------------------------------------------------
# restore active source
SaveData('Outputs/DictionaryCloud.vtm' , OutputPort(tTKPersistenceDiagramDictEncoding1 , 0))
SaveData('Outputs/WeightsCloud.csv', OutputPort(tTKPersistenceDiagramDictEncoding1 , 1), Precision = 8)
