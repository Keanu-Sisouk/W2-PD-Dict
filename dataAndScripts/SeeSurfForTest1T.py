...
# create a new 'XML Unstructured Grid Reader'
seeSurfDgm43vtu = XMLUnstructuredGridReader(registrationName='SeeSurfDgm43.vtu', FileName=['wassersteinMergeTreesData/data/SeeSurfNewDgms/SeeSurfDgm43.vtu'])
...
# create a new 'XML Unstructured Grid Reader'
seeSurfDgm27vtu = XMLUnstructuredGridReader(registrationName='SeeSurfDgm27.vtu', FileName=['wassersteinMergeTreesData/data/SeeSurfNewDgms/SeeSurfDgm27.vtu'])
...
# create a new 'XML Unstructured Grid Reader'
seeSurfDgm24vtu = XMLUnstructuredGridReader(registrationName='SeeSurfDgm24.vtu', FileName=['wassersteinMergeTreesData/data/SeeSurfNewDgms/SeeSurfDgm24.vtu'])
...
# create a new 'XML Unstructured Grid Reader'
seeSurfDgm31vtu = XMLUnstructuredGridReader(registrationName='SeeSurfDgm31.vtu', FileName=['wassersteinMergeTreesData/data/SeeSurfNewDgms/SeeSurfDgm31.vtu'])
...
# create a new 'XML Unstructured Grid Reader'
seeSurfDgm42vtu = XMLUnstructuredGridReader(registrationName='SeeSurfDgm42.vtu', FileName=['wassersteinMergeTreesData/data/SeeSurfNewDgms/SeeSurfDgm42.vtu'])
...
# create a new 'XML Unstructured Grid Reader'
seeSurfDgm28vtu = XMLUnstructuredGridReader(registrationName='SeeSurfDgm28.vtu', FileName=['wassersteinMergeTreesData/data/SeeSurfNewDgms/SeeSurfDgm28.vtu'])
...
# create a new 'XML Unstructured Grid Reader'
seeSurfDgm41vtu = XMLUnstructuredGridReader(registrationName='SeeSurfDgm41.vtu', FileName=['wassersteinMergeTreesData/data/SeeSurfNewDgms/SeeSurfDgm41.vtu'])
...
# create a new 'XML Unstructured Grid Reader'
seeSurfDgm40vtu = XMLUnstructuredGridReader(registrationName='SeeSurfDgm40.vtu', FileName=['wassersteinMergeTreesData/data/SeeSurfNewDgms/SeeSurfDgm40.vtu'])
...
# create a new 'XML Unstructured Grid Reader'
seeSurfDgm25vtu = XMLUnstructuredGridReader(registrationName='SeeSurfDgm25.vtu', FileName=['wassersteinMergeTreesData/data/SeeSurfNewDgms/SeeSurfDgm25.vtu'])
...
# create a new 'XML Unstructured Grid Reader'
seeSurfDgm4vtu = XMLUnstructuredGridReader(registrationName='SeeSurfDgm4.vtu', FileName=['wassersteinMergeTreesData/data/SeeSurfNewDgms/SeeSurfDgm4.vtu'])
...
# create a new 'XML Unstructured Grid Reader'
seeSurfDgm38vtu = XMLUnstructuredGridReader(registrationName='SeeSurfDgm38.vtu', FileName=['wassersteinMergeTreesData/data/SeeSurfNewDgms/SeeSurfDgm38.vtu'])
...
# create a new 'XML Unstructured Grid Reader'
seeSurfDgm29vtu = XMLUnstructuredGridReader(registrationName='SeeSurfDgm29.vtu', FileName=['wassersteinMergeTreesData/data/SeeSurfNewDgms/SeeSurfDgm29.vtu'])
...
# create a new 'XML Unstructured Grid Reader'
seeSurfDgm37vtu = XMLUnstructuredGridReader(registrationName='SeeSurfDgm37.vtu', FileName=['wassersteinMergeTreesData/data/SeeSurfNewDgms/SeeSurfDgm37.vtu'])
...
# create a new 'XML Unstructured Grid Reader'
seeSurfDgm13vtu = XMLUnstructuredGridReader(registrationName='SeeSurfDgm13.vtu', FileName=['wassersteinMergeTreesData/data/SeeSurfNewDgms/SeeSurfDgm13.vtu'])
...
# create a new 'XML Unstructured Grid Reader'
seeSurfDgm36vtu = XMLUnstructuredGridReader(registrationName='SeeSurfDgm36.vtu', FileName=['wassersteinMergeTreesData/data/SeeSurfNewDgms/SeeSurfDgm36.vtu'])
...
# create a new 'XML Unstructured Grid Reader'
seeSurfDgm14vtu = XMLUnstructuredGridReader(registrationName='SeeSurfDgm14.vtu', FileName=['wassersteinMergeTreesData/data/SeeSurfNewDgms/SeeSurfDgm14.vtu'])
...
# create a new 'XML Unstructured Grid Reader'
seeSurfDgm35vtu = XMLUnstructuredGridReader(registrationName='SeeSurfDgm35.vtu', FileName=['wassersteinMergeTreesData/data/SeeSurfNewDgms/SeeSurfDgm35.vtu'])
...
# create a new 'XML Unstructured Grid Reader'
seeSurfDgm30vtu = XMLUnstructuredGridReader(registrationName='SeeSurfDgm30.vtu', FileName=['wassersteinMergeTreesData/data/SeeSurfNewDgms/SeeSurfDgm30.vtu'])
...
# create a new 'XML Unstructured Grid Reader'
seeSurfDgm21vtu = XMLUnstructuredGridReader(registrationName='SeeSurfDgm21.vtu', FileName=['wassersteinMergeTreesData/data/SeeSurfNewDgms/SeeSurfDgm21.vtu'])
...
# create a new 'XML Unstructured Grid Reader'
seeSurfDgm1vtu = XMLUnstructuredGridReader(registrationName='SeeSurfDgm1.vtu', FileName=['wassersteinMergeTreesData/data/SeeSurfNewDgms/SeeSurfDgm1.vtu'])
...
# create a new 'XML Unstructured Grid Reader'
seeSurfDgm10vtu = XMLUnstructuredGridReader(registrationName='SeeSurfDgm10.vtu', FileName=['wassersteinMergeTreesData/data/SeeSurfNewDgms/SeeSurfDgm10.vtu'])
...
# create a new 'XML Unstructured Grid Reader'
seeSurfDgm32vtu = XMLUnstructuredGridReader(registrationName='SeeSurfDgm32.vtu', FileName=['wassersteinMergeTreesData/data/SeeSurfNewDgms/SeeSurfDgm32.vtu'])
...
# create a new 'XML Unstructured Grid Reader'
seeSurfDgm12vtu = XMLUnstructuredGridReader(registrationName='SeeSurfDgm12.vtu', FileName=['wassersteinMergeTreesData/data/SeeSurfNewDgms/SeeSurfDgm12.vtu'])
...
# create a new 'XML Unstructured Grid Reader'
seeSurfDgm9vtu = XMLUnstructuredGridReader(registrationName='SeeSurfDgm9.vtu', FileName=['wassersteinMergeTreesData/data/SeeSurfNewDgms/SeeSurfDgm9.vtu'])
...
# create a new 'XML Unstructured Grid Reader'
seeSurfDgm3vtu = XMLUnstructuredGridReader(registrationName='SeeSurfDgm3.vtu', FileName=['wassersteinMergeTreesData/data/SeeSurfNewDgms/SeeSurfDgm3.vtu'])
...
# create a new 'XML Unstructured Grid Reader'
seeSurfDgm8vtu = XMLUnstructuredGridReader(registrationName='SeeSurfDgm8.vtu', FileName=['wassersteinMergeTreesData/data/SeeSurfNewDgms/SeeSurfDgm8.vtu'])
...
# create a new 'XML Unstructured Grid Reader'
seeSurfDgm33vtu = XMLUnstructuredGridReader(registrationName='SeeSurfDgm33.vtu', FileName=['wassersteinMergeTreesData/data/SeeSurfNewDgms/SeeSurfDgm33.vtu'])
...
# create a new 'XML Unstructured Grid Reader'
seeSurfDgm17vtu = XMLUnstructuredGridReader(registrationName='SeeSurfDgm17.vtu', FileName=['wassersteinMergeTreesData/data/SeeSurfNewDgms/SeeSurfDgm17.vtu'])
...
# create a new 'XML Unstructured Grid Reader'
seeSurfDgm7vtu = XMLUnstructuredGridReader(registrationName='SeeSurfDgm7.vtu', FileName=['wassersteinMergeTreesData/data/SeeSurfNewDgms/SeeSurfDgm7.vtu'])
...
# create a new 'XML Unstructured Grid Reader'
seeSurfDgm11vtu = XMLUnstructuredGridReader(registrationName='SeeSurfDgm11.vtu', FileName=['wassersteinMergeTreesData/data/SeeSurfNewDgms/SeeSurfDgm11.vtu'])
...
# create a new 'XML Unstructured Grid Reader'
seeSurfDgm19vtu = XMLUnstructuredGridReader(registrationName='SeeSurfDgm19.vtu', FileName=['wassersteinMergeTreesData/data/SeeSurfNewDgms/SeeSurfDgm19.vtu'])
...
# create a new 'XML Unstructured Grid Reader'
seeSurfDgm6vtu = XMLUnstructuredGridReader(registrationName='SeeSurfDgm6.vtu', FileName=['wassersteinMergeTreesData/data/SeeSurfNewDgms/SeeSurfDgm6.vtu'])
...
# create a new 'XML Unstructured Grid Reader'
seeSurfDgm23vtu = XMLUnstructuredGridReader(registrationName='SeeSurfDgm23.vtu', FileName=['wassersteinMergeTreesData/data/SeeSurfNewDgms/SeeSurfDgm23.vtu'])
...
# create a new 'XML Unstructured Grid Reader'
seeSurfDgm22vtu = XMLUnstructuredGridReader(registrationName='SeeSurfDgm22.vtu', FileName=['wassersteinMergeTreesData/data/SeeSurfNewDgms/SeeSurfDgm22.vtu'])
...
# create a new 'XML Unstructured Grid Reader'
seeSurfDgm16vtu = XMLUnstructuredGridReader(registrationName='SeeSurfDgm16.vtu', FileName=['wassersteinMergeTreesData/data/SeeSurfNewDgms/SeeSurfDgm16.vtu'])
...
# create a new 'XML Unstructured Grid Reader'
seeSurfDgm34vtu = XMLUnstructuredGridReader(registrationName='SeeSurfDgm34.vtu', FileName=['wassersteinMergeTreesData/data/SeeSurfNewDgms/SeeSurfDgm34.vtu'])
...
# create a new 'XML Unstructured Grid Reader'
seeSurfDgm20vtu = XMLUnstructuredGridReader(registrationName='SeeSurfDgm20.vtu', FileName=['wassersteinMergeTreesData/data/SeeSurfNewDgms/SeeSurfDgm20.vtu'])
...
# create a new 'XML Unstructured Grid Reader'
seeSurfDgm15vtu = XMLUnstructuredGridReader(registrationName='SeeSurfDgm15.vtu', FileName=['wassersteinMergeTreesData/data/SeeSurfNewDgms/SeeSurfDgm15.vtu'])
...
# create a new 'XML Unstructured Grid Reader'
seeSurfDgm5vtu = XMLUnstructuredGridReader(registrationName='SeeSurfDgm5.vtu', FileName=['wassersteinMergeTreesData/data/SeeSurfNewDgms/SeeSurfDgm5.vtu'])
...
# create a new 'XML Unstructured Grid Reader'
seeSurfDgm2vtu = XMLUnstructuredGridReader(registrationName='SeeSurfDgm2.vtu', FileName=['wassersteinMergeTreesData/data/SeeSurfNewDgms/SeeSurfDgm2.vtu'])
...
# create a new 'XML Unstructured Grid Reader'
seeSurfDgm48vtu = XMLUnstructuredGridReader(registrationName='SeeSurfDgm48.vtu', FileName=['wassersteinMergeTreesData/data/SeeSurfNewDgms/SeeSurfDgm48.vtu'])
...
# create a new 'XML Unstructured Grid Reader'
seeSurfDgm18vtu = XMLUnstructuredGridReader(registrationName='SeeSurfDgm18.vtu', FileName=['wassersteinMergeTreesData/data/SeeSurfNewDgms/SeeSurfDgm18.vtu'])
...
# create a new 'XML Unstructured Grid Reader'
seeSurfDgm47vtu = XMLUnstructuredGridReader(registrationName='SeeSurfDgm47.vtu', FileName=['wassersteinMergeTreesData/data/SeeSurfNewDgms/SeeSurfDgm47.vtu'])
...
# create a new 'XML Unstructured Grid Reader'
seeSurfDgm46vtu = XMLUnstructuredGridReader(registrationName='SeeSurfDgm46.vtu', FileName=['wassersteinMergeTreesData/data/SeeSurfNewDgms/SeeSurfDgm46.vtu'])
...
# create a new 'XML Unstructured Grid Reader'
seeSurfDgm26vtu = XMLUnstructuredGridReader(registrationName='SeeSurfDgm26.vtu', FileName=['wassersteinMergeTreesData/data/SeeSurfNewDgms/SeeSurfDgm26.vtu'])
...
# create a new 'XML Unstructured Grid Reader'
seeSurfDgm45vtu = XMLUnstructuredGridReader(registrationName='SeeSurfDgm45.vtu', FileName=['wassersteinMergeTreesData/data/SeeSurfNewDgms/SeeSurfDgm45.vtu'])
...
# create a new 'XML Unstructured Grid Reader'
seeSurfDgm44vtu = XMLUnstructuredGridReader(registrationName='SeeSurfDgm44.vtu', FileName=['wassersteinMergeTreesData/data/SeeSurfNewDgms/SeeSurfDgm44.vtu'])
...
SaveData('Outputs/DictionarySeaSurfaceHeight.vtm' , OutputPort(tTKPersistenceDiagramDictEncoding1 , 0))
SaveData('Outputs/WeightsSeaSurfaceHeight.csv', OutputPort(tTKPersistenceDiagramDictEncoding1 , 1), Precision = 8)
