...
cloudDgm11vtu = XMLUnstructuredGridReader(registrationName='cloudDgm11.vtu', FileName=['/home/keanu/ttk-data/wassersteinMergeTreesData/cloud/cloudDgm11.vtu'])
...
# create a new 'XML Unstructured Grid Reader'
cloudDgm2vtu = XMLUnstructuredGridReader(registrationName='cloudDgm2.vtu', FileName=['/home/keanu/ttk-data/wassersteinMergeTreesData/cloud/cloudDgm2.vtu'])
...
# create a new 'XML Unstructured Grid Reader'
cloudDgm3vtu = XMLUnstructuredGridReader(registrationName='cloudDgm3.vtu', FileName=['/home/keanu/ttk-data/wassersteinMergeTreesData/cloud/cloudDgm3.vtu'])
...
# create a new 'XML Unstructured Grid Reader'
cloudDgm0vtu = XMLUnstructuredGridReader(registrationName='cloudDgm0.vtu', FileName=['/home/keanu/ttk-data/wassersteinMergeTreesData/cloud/cloudDgm0.vtu'])
...
# create a new 'XML Unstructured Grid Reader'
cloudDgm1vtu = XMLUnstructuredGridReader(registrationName='cloudDgm1.vtu', FileName=['/home/keanu/ttk-data/wassersteinMergeTreesData/cloud/cloudDgm1.vtu'])
...
# create a new 'XML Unstructured Grid Reader'
cloudDgm6vtu = XMLUnstructuredGridReader(registrationName='cloudDgm6.vtu', FileName=['/home/keanu/ttk-data/wassersteinMergeTreesData/cloud/cloudDgm6.vtu'])
...
# create a new 'XML Unstructured Grid Reader'
cloudDgm10vtu = XMLUnstructuredGridReader(registrationName='cloudDgm10.vtu', FileName=['/home/keanu/ttk-data/wassersteinMergeTreesData/cloud/cloudDgm10.vtu'])
...
# create a new 'XML Unstructured Grid Reader'
cloudDgm8vtu = XMLUnstructuredGridReader(registrationName='cloudDgm8.vtu', FileName=['/home/keanu/ttk-data/wassersteinMergeTreesData/cloud/cloudDgm8.vtu'])
...
# create a new 'XML Unstructured Grid Reader'
cloudDgm4vtu = XMLUnstructuredGridReader(registrationName='cloudDgm4.vtu', FileName=['/home/keanu/ttk-data/wassersteinMergeTreesData/cloud/cloudDgm4.vtu'])
...
# create a new 'XML Unstructured Grid Reader'
cloudDgm9vtu = XMLUnstructuredGridReader(registrationName='cloudDgm9.vtu', FileName=['/home/keanu/ttk-data/wassersteinMergeTreesData/cloud/cloudDgm9.vtu'])
...
# create a new 'XML Unstructured Grid Reader'
cloudDgm7vtu = XMLUnstructuredGridReader(registrationName='cloudDgm7.vtu', FileName=['/home/keanu/ttk-data/wassersteinMergeTreesData/cloud/cloudDgm7.vtu'])
...
# create a new 'XML Unstructured Grid Reader'
cloudDgm5vtu = XMLUnstructuredGridReader(registrationName='cloudDgm5.vtu', FileName=['/home/keanu/ttk-data/wassersteinMergeTreesData/cloud/cloudDgm5.vtu'])
...
SaveData('TimersCloud1T.csv', OutputPort(tTKPersistenceDiagramDictEncoding1 , 5))
