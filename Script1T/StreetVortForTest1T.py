...
vortexStreetGoodEnsemble2vti = XMLImageDataReader(registrationName='vortexStreetGoodEnsemble2.vti', FileName=['/home/keanu/ttk-data/wassersteinMergeTreesData/data/vortexStreetGoodEnsemble2.vti'])
...
SaveData('TimersStreetVort1PercProgMaxMinTest1T.csv', OutputPort(tTKPersistenceDiagramDictEncoding1, 5))
