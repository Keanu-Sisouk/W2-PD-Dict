...
ionization3DDgm8vtu = XMLUnstructuredGridReader(registrationName='ionization3DDgm8.vtu', FileName=['/home/keanu/ttk-data/wassersteinMergeTreesData/2008_ionization_front_3D/ionization3DDgm8.vtu'])
...
# create a new 'XML Unstructured Grid Reader'
ionization3DDgm5vtu = XMLUnstructuredGridReader(registrationName='ionization3DDgm5.vtu', FileName=['/home/keanu/ttk-data/wassersteinMergeTreesData/2008_ionization_front_3D/ionization3DDgm5.vtu'])
...
# create a new 'XML Unstructured Grid Reader'
ionization3DDgm9vtu = XMLUnstructuredGridReader(registrationName='ionization3DDgm9.vtu', FileName=['/home/keanu/ttk-data/wassersteinMergeTreesData/2008_ionization_front_3D/ionization3DDgm9.vtu'])
...
# create a new 'XML Unstructured Grid Reader'
ionization3DDgm11vtu = XMLUnstructuredGridReader(registrationName='ionization3DDgm11.vtu', FileName=['/home/keanu/ttk-data/wassersteinMergeTreesData/2008_ionization_front_3D/ionization3DDgm11.vtu'])
...
# create a new 'XML Unstructured Grid Reader'
ionization3DDgm1vtu = XMLUnstructuredGridReader(registrationName='ionization3DDgm1.vtu', FileName=['/home/keanu/ttk-data/wassersteinMergeTreesData/2008_ionization_front_3D/ionization3DDgm1.vtu'])
...
# create a new 'XML Unstructured Grid Reader'
ionization3DDgm2vtu = XMLUnstructuredGridReader(registrationName='ionization3DDgm2.vtu', FileName=['/home/keanu/ttk-data/wassersteinMergeTreesData/2008_ionization_front_3D/ionization3DDgm2.vtu'])
...
# create a new 'XML Unstructured Grid Reader'
ionization3DDgm13vtu = XMLUnstructuredGridReader(registrationName='ionization3DDgm13.vtu', FileName=['/home/keanu/ttk-data/wassersteinMergeTreesData/2008_ionization_front_3D/ionization3DDgm13.vtu'])
...
# create a new 'XML Unstructured Grid Reader'
ionization3DDgm14vtu = XMLUnstructuredGridReader(registrationName='ionization3DDgm14.vtu', FileName=['/home/keanu/ttk-data/wassersteinMergeTreesData/2008_ionization_front_3D/ionization3DDgm14.vtu'])
...
# create a new 'XML Unstructured Grid Reader'
ionization3DDgm12vtu = XMLUnstructuredGridReader(registrationName='ionization3DDgm12.vtu', FileName=['/home/keanu/ttk-data/wassersteinMergeTreesData/2008_ionization_front_3D/ionization3DDgm12.vtu'])
...
# create a new 'XML Unstructured Grid Reader'
ionization3DDgm10vtu = XMLUnstructuredGridReader(registrationName='ionization3DDgm10.vtu', FileName=['/home/keanu/ttk-data/wassersteinMergeTreesData/2008_ionization_front_3D/ionization3DDgm10.vtu'])
...
# create a new 'XML Unstructured Grid Reader'
ionization3DDgm7vtu = XMLUnstructuredGridReader(registrationName='ionization3DDgm7.vtu', FileName=['/home/keanu/ttk-data/wassersteinMergeTreesData/2008_ionization_front_3D/ionization3DDgm7.vtu'])
...
# create a new 'XML Unstructured Grid Reader'
ionization3DDgm4vtu = XMLUnstructuredGridReader(registrationName='ionization3DDgm4.vtu', FileName=['/home/keanu/ttk-data/wassersteinMergeTreesData/2008_ionization_front_3D/ionization3DDgm4.vtu'])
...
# create a new 'XML Unstructured Grid Reader'
ionization3DDgm3vtu = XMLUnstructuredGridReader(registrationName='ionization3DDgm3.vtu', FileName=['/home/keanu/ttk-data/wassersteinMergeTreesData/2008_ionization_front_3D/ionization3DDgm3.vtu'])
...
# create a new 'XML Unstructured Grid Reader'
ionization3DDgm15vtu = XMLUnstructuredGridReader(registrationName='ionization3DDgm15.vtu', FileName=['/home/keanu/ttk-data/wassersteinMergeTreesData/2008_ionization_front_3D/ionization3DDgm15.vtu'])
...
# create a new 'XML Unstructured Grid Reader'
ionization3DDgm0vtu = XMLUnstructuredGridReader(registrationName='ionization3DDgm0.vtu', FileName=['/home/keanu/ttk-data/wassersteinMergeTreesData/2008_ionization_front_3D/ionization3DDgm0.vtu'])
...
# create a new 'XML Unstructured Grid Reader'
ionization3DDgm6vtu = XMLUnstructuredGridReader(registrationName='ionization3DDgm6.vtu', FileName=['/home/keanu/ttk-data/wassersteinMergeTreesData/2008_ionization_front_3D/ionization3DDgm6.vtu'])
...
SaveData('TimersIonization3D1PercProgMaxTest1T.csv', OutputPort(tTKPersistenceDiagramDictEncoding1 , 5))
