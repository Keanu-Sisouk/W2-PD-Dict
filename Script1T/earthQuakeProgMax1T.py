...
diagEarthQuake10vtu = XMLUnstructuredGridReader(registrationName='DiagEarthQuake10.vtu', FileName=['/home/keanu/ttk-data/wassersteinMergeTreesData/2006_earthquake_3D/DiagEarthQuake10.vtu'])
...
# create a new 'XML Unstructured Grid Reader'
diagEarthQuake0vtu = XMLUnstructuredGridReader(registrationName='DiagEarthQuake0.vtu', FileName=['/home/keanu/ttk-data/wassersteinMergeTreesData/2006_earthquake_3D/DiagEarthQuake0.vtu'])
...
# create a new 'XML Unstructured Grid Reader'
diagEarthQuake7vtu = XMLUnstructuredGridReader(registrationName='DiagEarthQuake7.vtu', FileName=['/home/keanu/ttk-data/wassersteinMergeTreesData/2006_earthquake_3D/DiagEarthQuake7.vtu'])
...
# create a new 'XML Unstructured Grid Reader'
diagEarthQuake2vtu = XMLUnstructuredGridReader(registrationName='DiagEarthQuake2.vtu', FileName=['/home/keanu/ttk-data/wassersteinMergeTreesData/2006_earthquake_3D/DiagEarthQuake2.vtu'])
...
# create a new 'XML Unstructured Grid Reader'
diagEarthQuake9vtu = XMLUnstructuredGridReader(registrationName='DiagEarthQuake9.vtu', FileName=['/home/keanu/ttk-data/wassersteinMergeTreesData/2006_earthquake_3D/DiagEarthQuake9.vtu'])
...
# create a new 'XML Unstructured Grid Reader'
diagEarthQuake8vtu = XMLUnstructuredGridReader(registrationName='DiagEarthQuake8.vtu', FileName=['/home/keanu/ttk-data/wassersteinMergeTreesData/2006_earthquake_3D/DiagEarthQuake8.vtu'])
...
# create a new 'XML Unstructured Grid Reader'
diagEarthQuake3vtu = XMLUnstructuredGridReader(registrationName='DiagEarthQuake3.vtu', FileName=['/home/keanu/ttk-data/wassersteinMergeTreesData/2006_earthquake_3D/DiagEarthQuake3.vtu'])
...
# create a new 'XML Unstructured Grid Reader'
diagEarthQuake6vtu = XMLUnstructuredGridReader(registrationName='DiagEarthQuake6.vtu', FileName=['/home/keanu/ttk-data/wassersteinMergeTreesData/2006_earthquake_3D/DiagEarthQuake6.vtu'])
...
# create a new 'XML Unstructured Grid Reader'
diagEarthQuake11vtu = XMLUnstructuredGridReader(registrationName='DiagEarthQuake11.vtu', FileName=['/home/keanu/ttk-data/wassersteinMergeTreesData/2006_earthquake_3D/DiagEarthQuake11.vtu'])
...
# create a new 'XML Unstructured Grid Reader'
diagEarthQuake5vtu = XMLUnstructuredGridReader(registrationName='DiagEarthQuake5.vtu', FileName=['/home/keanu/ttk-data/wassersteinMergeTreesData/2006_earthquake_3D/DiagEarthQuake5.vtu'])
...
# create a new 'XML Unstructured Grid Reader'
diagEarthQuake4vtu = XMLUnstructuredGridReader(registrationName='DiagEarthQuake4.vtu', FileName=['/home/keanu/ttk-data/wassersteinMergeTreesData/2006_earthquake_3D/DiagEarthQuake4.vtu'])
...
# create a new 'XML Unstructured Grid Reader'
diagEarthQuake1vtu = XMLUnstructuredGridReader(registrationName='DiagEarthQuake1.vtu', FileName=['/home/keanu/ttk-data/wassersteinMergeTreesData/2006_earthquake_3D/DiagEarthQuake1.vtu'])
...
SaveData('TimersEarthQuake1T.csv', OutputPort(tTKPersistenceDiagramDictEncoding1 , 5))
