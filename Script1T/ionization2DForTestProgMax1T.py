...
ionization2DDgm8vtu = XMLUnstructuredGridReader(registrationName='ionization2DDgm8.vtu', FileName=['/home/keanu/ttk-data/wassersteinMergeTreesData/2008_ionization_front_2D/ionization2DDgm8.vtu'])
...
# create a new 'XML Unstructured Grid Reader'
ionization2DDgm5vtu = XMLUnstructuredGridReader(registrationName='ionization2DDgm5.vtu', FileName=['/home/keanu/ttk-data/wassersteinMergeTreesData/2008_ionization_front_2D/ionization2DDgm5.vtu'])
...
# create a new 'XML Unstructured Grid Reader'
ionization2DDgm9vtu = XMLUnstructuredGridReader(registrationName='ionization2DDgm9.vtu', FileName=['/home/keanu/ttk-data/wassersteinMergeTreesData/2008_ionization_front_2D/ionization2DDgm9.vtu'])
...
# create a new 'XML Unstructured Grid Reader'
ionization2DDgm11vtu = XMLUnstructuredGridReader(registrationName='ionization2DDgm11.vtu', FileName=['/home/keanu/ttk-data/wassersteinMergeTreesData/2008_ionization_front_2D/ionization2DDgm11.vtu'])
...
# create a new 'XML Unstructured Grid Reader'
ionization2DDgm1vtu = XMLUnstructuredGridReader(registrationName='ionization2DDgm1.vtu', FileName=['/home/keanu/ttk-data/wassersteinMergeTreesData/2008_ionization_front_2D/ionization2DDgm1.vtu'])
...
# create a new 'XML Unstructured Grid Reader'
ionization2DDgm2vtu = XMLUnstructuredGridReader(registrationName='ionization2DDgm2.vtu', FileName=['/home/keanu/ttk-data/wassersteinMergeTreesData/2008_ionization_front_2D/ionization2DDgm2.vtu'])
...
# create a new 'XML Unstructured Grid Reader'
ionization2DDgm13vtu = XMLUnstructuredGridReader(registrationName='ionization2DDgm13.vtu', FileName=['/home/keanu/ttk-data/wassersteinMergeTreesData/2008_ionization_front_2D/ionization2DDgm13.vtu'])
...
# create a new 'XML Unstructured Grid Reader'
ionization2DDgm14vtu = XMLUnstructuredGridReader(registrationName='ionization2DDgm14.vtu', FileName=['/home/keanu/ttk-data/wassersteinMergeTreesData/2008_ionization_front_2D/ionization2DDgm14.vtu'])
...
# create a new 'XML Unstructured Grid Reader'
ionization2DDgm12vtu = XMLUnstructuredGridReader(registrationName='ionization2DDgm12.vtu', FileName=['/home/keanu/ttk-data/wassersteinMergeTreesData/2008_ionization_front_2D/ionization2DDgm12.vtu'])
...
# create a new 'XML Unstructured Grid Reader'
ionization2DDgm10vtu = XMLUnstructuredGridReader(registrationName='ionization2DDgm10.vtu', FileName=['/home/keanu/ttk-data/wassersteinMergeTreesData/2008_ionization_front_2D/ionization2DDgm10.vtu'])
...
# create a new 'XML Unstructured Grid Reader'
ionization2DDgm7vtu = XMLUnstructuredGridReader(registrationName='ionization2DDgm7.vtu', FileName=['/home/keanu/ttk-data/wassersteinMergeTreesData/2008_ionization_front_2D/ionization2DDgm7.vtu'])
...
# create a new 'XML Unstructured Grid Reader'
ionization2DDgm4vtu = XMLUnstructuredGridReader(registrationName='ionization2DDgm4.vtu', FileName=['/home/keanu/ttk-data/wassersteinMergeTreesData/2008_ionization_front_2D/ionization2DDgm4.vtu'])
...
# create a new 'XML Unstructured Grid Reader'
ionization2DDgm3vtu = XMLUnstructuredGridReader(registrationName='ionization2DDgm3.vtu', FileName=['/home/keanu/ttk-data/wassersteinMergeTreesData/2008_ionization_front_2D/ionization2DDgm3.vtu'])
...
# create a new 'XML Unstructured Grid Reader'
ionization2DDgm15vtu = XMLUnstructuredGridReader(registrationName='ionization2DDgm15.vtu', FileName=['/home/keanu/ttk-data/wassersteinMergeTreesData/2008_ionization_front_2D/ionization2DDgm15.vtu'])
...
# create a new 'XML Unstructured Grid Reader'
ionization2DDgm0vtu = XMLUnstructuredGridReader(registrationName='ionization2DDgm0.vtu', FileName=['/home/keanu/ttk-data/wassersteinMergeTreesData/2008_ionization_front_2D/ionization2DDgm0.vtu'])
...
# create a new 'XML Unstructured Grid Reader'
ionization2DDgm6vtu = XMLUnstructuredGridReader(registrationName='ionization2DDgm6.vtu', FileName=['/home/keanu/ttk-data/wassersteinMergeTreesData/2008_ionization_front_2D/ionization2DDgm6.vtu'])
...
SaveData('TimersIonization2D0PercProgMaxTest1T.csv', OutputPort(tTKPersistenceDiagramDictEncoding1 , 5))
